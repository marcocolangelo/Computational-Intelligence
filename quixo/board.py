...
class Board():
    ...
    def get_legal_actions(self):
        ...
        for from_pos in from_all_possible_pos:
            ...
            if self._board[from_pos] != self.player_id and self._board[from_pos] != -1:
    ...
    def move(self, action, player_id):
        from_pos, slide = action
        # Equivalente delle funzioni _take e _slide di Game
        self._board[from_pos] = player_id # _take
        # _slide
