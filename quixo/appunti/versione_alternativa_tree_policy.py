...
from minimax_noMCTS import MiniMax



class MonteCarloTreeSearchNodeMB():
    def __init__(self, state: Board, player_id, d, id, root_player,parent : 'MonteCarloTreeSearchNodeMB' = None, parent_action=None, minmax_depth = 4,num_simulations=100, c_param=0.1):
