...
def clustering():
        # Carica i dati
    data = np.load("won_test3.npy")
    data2 = np.load("lost_test3.npy")
...
if __name__ == '__main__':
    ...
    X = np.array([[1, -1, 1,-1, 0],
                         ...
                         [1, -1, -1, 0, 0],
                         [1, 0, 1, 0, 1]])
    features = normalize(X,pca)
    Y_pred = model.predict(features)
    print(f"Previsione: {Y_pred}")